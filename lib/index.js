...
var debug = require('visionmedia-debug')('dex:database');
var delegate = require('yields-delegate-events');
...
Database.prototype.abort = function(){
  for (var mode in this.transactions) {
    var t = this.transactions[mode];
    if (!t) continue;
    t.abort();
    this.transactions[mode] = null;
  }
  return this;
};
...
/**
 * Delegate batch events.
 *
 * @api private
 */

Database.prototype.delegate = function(){
  delegate(this.batch, this, ['progress']);
};
